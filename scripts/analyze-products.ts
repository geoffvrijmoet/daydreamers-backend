...
async function analyzeProducts(): Promise<ProductAnalysis> {
  ...
  try {
    ...
    analysis.totalDocuments = products.length;
    console.log(`Analyzing ${analysis.totalDocuments} product documents...`);
